...
* GitOps is the morden way of implementing continues delivery as git repositories are the only source of truth for your infrastructure and application code.
